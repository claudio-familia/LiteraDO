...
namespace LiteraDO.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class StoryCharactersController : BaseController<StoryCharacter>
    {
        public StoryCharactersController(IBaseService<StoryCharacter> baseService) : base(baseService)
        {
        }
    }
}
